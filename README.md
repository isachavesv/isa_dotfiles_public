Scripts I wrote/copy pasted/adapted to install my stack/dotfiles on any machine. May be useful for others (esp. academics). Expects sudo access various places.
